"""
유튜브 영상 기획 비서 MCP 서버
카카오 PlayMCP / AGENTIC PLAYER 10 출품용 프로토타입.
외부 API 없이 규칙 기반으로 동작하여 결과가 항상 일관됩니다.
"""
